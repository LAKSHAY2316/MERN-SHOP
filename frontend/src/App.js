  ...
  const routes = createBrowserRouter(
    createRoutesFromElements(
      <>
        ...
        <Route path="/admin/product-update/:id" element={<Protected adminOnly><ProductUpdatePage /></Protected>} />
        <Route path="/admin/add-product" element={<Protected adminOnly><AddProductPage /></Protected>} />
        <Route path="/admin/orders" element={<Protected adminOnly><AdminOrdersPage /></Protected>} />
